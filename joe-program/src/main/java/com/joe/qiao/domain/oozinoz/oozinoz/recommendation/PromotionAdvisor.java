package com.joe.qiao.domain.oozinoz.oozinoz.recommendation;
...
import com.joe.qiao.domain.oozinoz.oozinoz.firework.Firework;
...
public class PromotionAdvisor implements Advisor {
    ...
    public PromotionAdvisor() {
        try {
            ...
            p.load(ClassLoader.getSystemResourceAsStream("com/joe/qiao/domain/oozinoz/config/strategy.dat"));
