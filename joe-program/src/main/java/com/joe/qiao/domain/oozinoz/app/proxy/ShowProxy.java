package com.joe.qiao.domain.oozinoz.app.proxy;
...
import com.joe.qiao.domain.oozinoz.oozinoz.imaging.ImageIconProxy;
import com.joe.qiao.domain.oozinoz.oozinoz.imaging.LoadingImageIcon;
...
public class ShowProxy implements ActionListener {
    private ImageIconProxy proxy = new ImageIconProxy("com/joe/qiao/domain/oozinoz/images/fest.jpg");
