package com.joe.qiao.domain.oozinoz.oozinoz.imaging;
...
public class ImageIconProxy extends ImageIcon implements Runnable {
    static final ImageIcon ABSENT = new ImageIcon(ClassLoader.getSystemResource("com/joe/qiao/domain/oozinoz/images/absent.jpg"));
    static final ImageIcon LOADING = new ImageIcon(ClassLoader.getSystemResource("com/joe/qiao/domain/oozinoz/images/loading.jpg"));
