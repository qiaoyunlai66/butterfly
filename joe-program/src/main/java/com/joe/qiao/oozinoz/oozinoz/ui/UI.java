package com.joe.qiao.oozinoz.oozinoz.ui;
...
public class UI {
	...
	public JButton createButtonOk() {
		...
		button.setIcon(getIcon("com/joe/qiao/oozinoz/images/rocket-large.gif"));
		button.setText("Ok!");
		return button;
	}
	...
	public JButton createButtonCancel() {
		JButton button = createButton();
		button.setIcon(getIcon("com/joe/qiao/oozinoz/images/rocket-large-down.gif"));
