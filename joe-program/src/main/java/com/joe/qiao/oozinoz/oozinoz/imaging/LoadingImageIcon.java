package com.joe.qiao.oozinoz.oozinoz.imaging;
...
public class LoadingImageIcon extends ImageIcon implements Runnable {
    static final ImageIcon ABSENT = new ImageIcon(ClassLoader.getSystemResource("com/joe/qiao/oozinoz/images/absent.jpg"));
    static final ImageIcon LOADING = new ImageIcon(ClassLoader.getSystemResource("com/joe/qiao/oozinoz/images/loading.jpg"));
