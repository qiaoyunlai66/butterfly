package com.joe.qiao.oozinoz.oozinoz.recommendation;
...
import com.joe.qiao.oozinoz.oozinoz.firework.Firework;
...
public class PromotionAdvisor implements Advisor {
    ...
    public PromotionAdvisor() {
        try {
            ...
            p.load(ClassLoader.getSystemResourceAsStream("com/joe/qiao/oozinoz/config/strategy.dat"));
